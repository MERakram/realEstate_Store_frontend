...
class editCustomerAccount extends StatefulWidget {
  @override
  _editCustomerAccountState createState() {
    return _editCustomerAccountState();
  }
}

class _editCustomerAccountState extends State<editCustomerAccount> {
  var _accountData;
